...
public class WebController {
    ...
    public String getHome(Model model) {
        try {
            ...
            model.addAttribute("newMoviesLe", movieService.getNewMoviesLe());
            model.addAttribute("newMoviesBo", movieService.getNewMoviesBo());
            model.addAttribute("newMoviesPCR", movieService.getNewMoviesPCR());
        } catch (Exception e){
            return "error";
        }
        return "web/index";
